"""
Django settings for GroupAssignmentOne project.
...
ROOT_URLCONF = 'GroupAssignmentOne.urls'
...
WSGI_APPLICATION = 'GroupAssignmentOne.wsgi.application'
